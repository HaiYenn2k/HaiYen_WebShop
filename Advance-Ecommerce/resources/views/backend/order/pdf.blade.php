...
<head>
  ...
  <title>Dat hang @if($order)- {{$order->order_number}} @endif</title>
...
<style type="text/css">
  ...
  <div class="invoice-header">
    <div class="float-left site-logo">
      <img src="{{asset('backend/img/logo_shop.png')}}" alt="">
    </div>
  ...
  <div class="invoice-description">
    ...
    <div class="invoice-right-top float-right" class="text-right">
      <h3>Don hang ID: {{$order->order_number}}</h3>
