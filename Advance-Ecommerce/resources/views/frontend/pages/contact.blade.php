						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Liên hệ</h4>
									<h3>Viết 1 tin nhắn tới chúng tôi @auth @else<span style="font-size:12px;" class="text-danger">[Bạn cần đăng nhập trước]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="name" id="name" type="text" placeholder="Nhập tên của bạn" required>
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Tiêu đề<span>*</span></label>
												<input name="subject" type="text" id="subject" placeholder="Nhập tiêu đề" required>
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input id="phone" name="phone" type="number" placeholder="Nhập số điện thoại của bạn" required>
											</div>	
										</div>
										<div class="col-12">
											<div class="form-group message">
												<label>Tin nhắn của bạn<span>*</span></label>
												<textarea name="message" id="message" cols="30" rows="9" placeholder="Nhập tin nhắn" required></textarea>
											</div>
										</div>
										<div class="col-12">
