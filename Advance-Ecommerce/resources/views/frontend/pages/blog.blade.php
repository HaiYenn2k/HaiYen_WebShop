...
@section('title','FastFood | Trang Bài viết')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Trang Blog</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        {{-- {{$post}} --}}
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <img src="{{$post->photo}}" alt="{{$post->photo}}">
                                    <div class="content">
                                        <p class="date"><i class="fa fa-calendar" aria-hidden="true"></i> {{$post->created_at->format('D, d M, Y')}}
