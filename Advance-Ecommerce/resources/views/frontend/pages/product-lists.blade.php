...
@section('title','FastFood | Trang sản phẩm')
										...
										<div class="shop-shorter">
											<div class="single-shorter">
												...
												<select class="show" name="show" onchange="this.form.submit();">
													...
													<option value="50" @if(!empty($_GET['show']) && $_GET['show']=='40') selected @endif>50</option>
												</select>
											</div>
											<div class="single-shorter">
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Thêm vào danh sách ưa thích</span></a>
																</div>
													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
																...
																@endphp
																<span style="margin-top: 100px">{{number_format($after_discount,0)}} vnđ</span>
																<!-- <del style="margin-top: 100px">{{number_format($product->price,0)}} vnđ</del> -->
															</div>
															<h3 style="margin-top: 20px" class="title"><a href="{{route('product-detail',$product->slug)}}">{{$product->title}}</a></h3>
