        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    <h2 style="color: green">Từ bài viết của chúng tôi</h2>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="shop-single-blog">
                            ...
                            <div class="content">   
                                ...
                                <a style="color: green" href="{{route('blog.detail',$post->slug)}}" class="title">{{$post->title}}</a>
                                <a style="color: green" href="{{route('blog.detail',$post->slug)}}" class="more-btn">Tiếp tục đọc</a>
                            </div>
                        </div>
                        <!-- End Single Blog  -->
                    </div>
