            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 col-12">
                    <div class="search-bar-top">
                        <div class="search-bar" style="color: green">
                            <select>
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="@if(Request::path()=='product-grids'||Request::path()=='product-grids')  active  @endif"><a href="{{route('product-grids')}}">Sản phẩm</a><span class="new">Mới</span></li>												
