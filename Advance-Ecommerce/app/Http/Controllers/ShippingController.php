...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Đã tạo thành công giao hàng');
        }
        else{
    ...
    public function edit($id)
    {
        ...
        if(!$shipping){
            request()->session()->flash('error','Vận chuyển không tìm thấy');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Đã cập nhật giao hàng thành công');
        }
        else{
            request()->session()->flash('error','Lỗi. Vui lòng thử lại');
        }
